    ...
    public String format(boolean merged) {
        ...
        if (this.data instanceof Integer) {
            ...
            if (concateType == Concatenation.Concate.gtz)
                return val > 0 ? (merged ? this.sql.replace(wildcard, String.valueOf(this.data)) : this.sql) : null;
        ...
        if (this.data instanceof BigDecimal) {
            ...
            if (concateType == Concatenation.Concate.gtz && val.compareTo(BigDecimal.ZERO) > 0)
